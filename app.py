...
st.write("# Автор: Стариков Даниил")
st.write("# Проект: Визуализация и анализ данных, связанных с Формулой-1.")
st.sidebar.write("# Выберите, какой раздел Вы хотите увидеть:")
...
show1 = st.sidebar.checkbox("Показать Часть 1")
...
show2 = st.sidebar.checkbox("Показать Часть 2")
...
show3 = st.sidebar.checkbox("Показать Часть 3")
...
show4 = st.sidebar.checkbox("Показать Часть 4")
...
show5 = st.sidebar.checkbox("Показать Часть 5")
...
show6 = st.sidebar.checkbox("Показать Часть 6")
